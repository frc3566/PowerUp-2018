...
public class OI {
    ...
    public OI() {
        ...
        rotateLeft.whenPressed(new Rotate(Robot.var.rotateTimeOut, 
        		Robot.var.rotateSpeed, true));
        
        rotateRight = new JoystickButton(joystick1, 6);
        rotateRight.whenPressed(new Rotate(Robot.var.rotateTimeOut, 
        		Robot.var.rotateSpeed, false));
        ...
        SmartDashboard.putData("DriveForSeconds", 
        		new DriveForSeconds
        		(Robot.var.driveTimeOut, Robot.var.driveSpeed, true));
        SmartDashboard.putData("Rotate", new Rotate(Robot.var.rotateTimeOut, 
        		Robot.var.rotateSpeed, true));
