...
public class OI {
    ...
    public JoystickButton driveForTenF;
    public JoystickButton performRoute;
    ...
    public OI() {
        ...
        rotateLeft.whenPressed(new Rotate(-90));
        
        rotateRight = new JoystickButton(joystick1, 6);
        rotateRight.whenPressed(new Rotate(90));
        
        openField = new JoystickButton(joystick1, 8);
        openField.whenPressed(new OpenFieldSimulator());
        
        driveForTenF = new JoystickButton(joystick1, 1);
        driveForTenF.whenPressed(new DriveStraight(10));
        
        performRoute = new JoystickButton(joystick1, 2);
        performRoute.whenPressed(new CompleteRoute());
        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        //SmartDashboard.putData("Rotate", new Rotate());
        //SmartDashboard.putData("Perform Route", new CompleteRoute());
        SmartDashboard.putData("DriveForTenF", new DriveStraight(10));
