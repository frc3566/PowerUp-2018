...
//    public static double maxA=0.03;
    
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    //public static ControlledDrive drive;
    /**
    ...
    public void robotInit() {
        ...
        encoder1.setDistancePerPulse(-0.92);
        encoder2= new Encoder(2, 3, false, Encoder.EncodingType.k4X);
        encoder2.setDistancePerPulse(-1.35);
    ...
    public void teleopInit() {
        ...
        SmartDashboard.putNumber("I", 0.0004);
        SmartDashboard.putNumber("DD", 0.00018);
        SmartDashboard.putNumber("Distance", 1000);
        SmartDashboard.putNumber("maxPower", 1);
        SmartDashboard.putNumber("maxA", 0);    
        encoder1.reset();
        encoder2.reset();
